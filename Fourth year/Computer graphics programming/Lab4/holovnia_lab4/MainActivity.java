...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        menu.add(0, 1, 0, "myDiffuseLighting");
        menu.add(0, 2, 0, "mySpecularLighting");
        menu.add(0, 3, 0, "myPyramid");
        menu.add(0, 4, 0, "myNineCubes");
        //... add other menuitems
        return true;
    }
    @Override
