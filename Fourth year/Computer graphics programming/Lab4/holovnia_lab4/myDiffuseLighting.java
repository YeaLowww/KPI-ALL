...
public class myDiffuseLighting extends myWorkMode{
    ...
    private static final String fragmentShaderCode =
            "precision mediump float;\n" +
                    ...
                    "\n" +
                    "    // Фінальний результат: комбінуємо амбієнтне і дифузне освітлення\n" +
                    "    vec3 result = (ambient + diffuse * attenuation) * fragColor;\n" +
                    "\n" +
